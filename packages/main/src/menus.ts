import type { IpcMainEvent, MenuItemConstructorOptions, MenuItem} from 'electron';
import { BrowserWindow, ipcMain, Menu } from 'electron';
import { restoreOrCreateWindow as restoreOrCreatePreferencesWindow } from './preferencesWindow';
        ...
        [
          {
            ...
            submenu: [
              ...
              { type: 'separator' },
              {
                ...
                click: async () => { await restoreOrCreatePreferencesWindow(); },
              },
              { type: 'separator' },
              { role: 'services' },
              { type: 'separator' },
